...
**Last updated:** 2026-08-09 — **A dedicated Shopify app for Piro now exists and is deployed (`stockly-2`), and Stockly's core premise turned out to be void.** Both verified this session, not assumed.
