...
**Last updated:** 2026-08-11 (late) — **✅ THE PUBLIC APP EXISTS AND HAS THE CODE. The path is unblocked; what remains is submission material and Shopify's review.** Read `docs/decisions/ADR-018-functions-require-public-distribution.md` for why this was necessary, and `docs/app-store-submission-guide.md` for Jonatan's remaining tasks.
