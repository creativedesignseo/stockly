...
**Last updated:** 2026-08-11 — **🔴 READ `docs/decisions/ADR-018-functions-require-public-distribution.md` BEFORE PLANNING ANYTHING. Stockly's two Functions CANNOT run on Piro, and both existing apps are permanent dead ends for the App Store.** Everything below about the successful Piro install is still true — but the install cannot deliver the product.
