...
**Last commit:** `f8225a0` fix(registration): anchor storefront form font sizes (theme-proof; was 8.5px on root-10px themes). Prior prod commit `ffc9781` made server validation schema-driven.
